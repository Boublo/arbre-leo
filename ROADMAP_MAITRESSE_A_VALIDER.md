...
| 1 | OPS-001 / DATA-001 | Sauvegarde-restauration exercée et rapport de qualité non destructif | GOV-001 | partiel : QLT-001 à 005 et 008 à 010 livrés sur données fictives ; exercice isolé, CI et QLT-006 à 007 restent à faire |
...
- `UX-002` : rendre la recherche globale, avec résultats RLS filtrés ; réemployer la palette existante, sans exposer d’index de personnes invisibles.
- `UX-003` : afficher sur la fiche une prochaine étape simple selon ce qui existe : album, chronologie, sources ou souvenirs.
