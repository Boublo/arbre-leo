...
const EUROPE: Terre = {
  ...
  cote: [
    ...
    [7.27, 43.7], [6.64, 43.27], [5.93, 43.12], [5.35, 43.26], [4.85, 43.35],
    ...
    // Bretagne
    [-3.12, 47.48], [-3.92, 47.87], [-4.74, 48.04], [-4.79, 48.45], [-3.98, 48.73],
...
const MAGHREB: Terre = {
  ...
  cote: [
    ...
    // Le littoral oranais, un peu plus suivi que le reste : c'est là que la
    // famille a vécu, et un village posé dans la mer ferait mauvais effet.
    [-2.23, 35.09], [-1.86, 35.09], [-1.38, 35.3], [-1.28, 35.42], [-1.15, 35.55],
    [-0.99, 35.71], [-0.85, 35.8], [-0.71, 35.74], [-0.61, 35.72], [-0.32, 35.87],
