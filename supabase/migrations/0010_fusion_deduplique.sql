-- Ajout : avant de transférer les événements et sources vers la gardée, on
-- supprime chez la perdue tous ceux qui existent déjà identiquement chez la
-- gardée. Sans quoi le transfert bute sur les index d'unicité posés en 0007.
-- Les droits restent ouverts ici ; 0015 verrouille (est_admin + revoke anon).
